...
#followings route
Route::get('/users/{user}/followings', 'User\UserContorller@followings')->name('users.followings');
Route::get('/users/{user}/followers', 'User\UserContorller@followers')->name('users.followers');
